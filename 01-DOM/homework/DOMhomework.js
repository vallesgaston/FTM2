...
// Tu código acá:
let spanCreated = document.querySelector('#createdBy');
spanCreated.innerHTML = `${spanCreated.innerHTML} Javi Martinez`;
...
function displayToDos() {
  ...
  resultado.map(elem => toDoContainer.appendChild(elem));
}
